    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        private void OnFootstep(AnimationEvent animationEvent)
        {
            if (animationEvent.animatorClipInfo.weight > 0.5f)
            {
                ...
                {
                    Debug.Log("Ground: " + hit.collider.name + " / Tag: " + hit.collider.tag);

                    if (hit.collider.CompareTag("Wood"))
                    {
                        clipsToUse = WoodFootstepClips;
                    }
                    else if (hit.collider.CompareTag("Sand"))
                    {
                        clipsToUse = SandFootstepClips;
                    }
                }
                ...
                if (clipsToUse != null && clipsToUse.Length > 0)
                {
                    ...
                    GameObject soundObject = new GameObject("FootstepSound");

                    AudioSource source = soundObject.AddComponent<AudioSource>();

                    source.clip = clipsToUse[index];
                    ...
                    Destroy(soundObject, clipsToUse[index].length);
                }
            }
        }
